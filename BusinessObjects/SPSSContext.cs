...
public partial class SPSSContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            optionsBuilder.UseSqlServer("Server=(local);Database=SPSS;Uid=sa;Pwd=123456;TrustServerCertificate=True; Trusted_Connection=true");
            optionsBuilder.EnableSensitiveDataLogging();
        }
    }
    ...
    {
        modelBuilder.Entity<BlogSection>(BlogSection =>
        {
            BlogSection.ToTable("BlogSections");
            BlogSection.HasKey(e => e.Id);
            BlogSection.Property(e => e.Id).IsRequired();
            BlogSection.Property(e => e.ContentType).IsRequired().HasMaxLength(50);
            BlogSection.Property(e => e.Subtitle).HasMaxLength(200);
            BlogSection.Property(e => e.Content).IsRequired();
            BlogSection.Property(e => e.Order).IsRequired();
            BlogSection.HasOne(d => d.Blog)
        ...
        modelBuilder.Entity<SkinTypeRoutineStep>(SkinTypeRoutineSteps =>
        {
            SkinTypeRoutineSteps.ToTable("SkinTypeRoutineSteps");
            SkinTypeRoutineSteps.HasKey(e => e.Id);
            SkinTypeRoutineSteps.Property(e => e.Id).IsRequired();
            SkinTypeRoutineSteps.Property(e => e.SkinTypeId).IsRequired();
            SkinTypeRoutineSteps.Property(e => e.CategoryId).IsRequired();
            SkinTypeRoutineSteps.Property(e => e.StepName).IsRequired().HasMaxLength(255);
            SkinTypeRoutineSteps.Property(e => e.Instruction).HasColumnType("nvarchar(max)");
            SkinTypeRoutineSteps.Property(e => e.Order).IsRequired();
        });
